 ...
 * 
 */
Ext.namespace("mercuryecinf.areamaintain.info");

var AreaMaintainGridPanel = Ext.extend(Ext.grid.GridPanel,{
	id: 'AreaMaintainGridPanel',
	constructor: function(ctx){
		...
		BusinessDataGridPanel.superclass.constructor.call(this, {
