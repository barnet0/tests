...
LogPushDetailWin = Ext.extend(Ext.Window,{
	id: 'logPushDetailWinId',
	constructor: function(logPushMaintainV){
		
		Ext.Ajax.request({
	         url : 'logPushMaintain/showLogDetail.do',
	                  method: 'POST',
	                  params :{logPushMaintainId: logPushMaintainV},
	                  success: function ( result, request ) {
	                      ...
	                      if(jsonData.businessType == "OMS-REQUEST"){
							  ...
							  businessType = "SYNC手動拉取";
						  } else if(jsonData.businessType == "MANUAL-PUSH"){
							  businessType = "PUSH手動推送";
						  }else{
		...
		LogPushDetailWin.superclass.constructor.call(this, {
			title: ' 日 志 详 情 说 明 窗 ' ,
			resizable: false,
			width: 750,
			modal: true,
