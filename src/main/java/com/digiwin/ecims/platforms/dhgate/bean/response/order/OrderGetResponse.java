...
import com.digiwin.ecims.platforms.dhgate.bean.domain.order.OrderDeliveryInfo;
import com.digiwin.ecims.platforms.dhgate.bean.domain.order.OrderDetail;

public class OrderGetResponse extends BizStatusResponse {

  /**
   * 
   */
  private static final long serialVersionUID = 8887972932709214928L;
  // 必须 实收金额 示例值:100.00
