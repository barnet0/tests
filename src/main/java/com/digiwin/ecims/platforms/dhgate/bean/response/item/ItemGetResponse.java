...
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemAttrgroupUpdate;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemBaseUpdate;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemDetail;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemImgUpdate;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemInventoryUpdate;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemPackageUpdate;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemSaleSettingUpdate;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemSkuUpdate;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemSpecSelfDefUpdate;
import com.digiwin.ecims.platforms.dhgate.bean.domain.item.ItemWholesaleRangeUpdate;

public class ItemGetResponse extends BizStatusResponse {

  /**
   * 
   */
  private static final long serialVersionUID = 2289634401934389093L;
