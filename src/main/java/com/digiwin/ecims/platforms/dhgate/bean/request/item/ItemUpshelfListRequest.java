 ...
 *
 */
public class ItemUpshelfListRequest extends DhgateBaseRequest<ItemUpshelfListResponse> {
  ...
  public ItemUpshelfListRequest() {
    super();
  }

  @Override
  public Class<ItemUpshelfListResponse> getResponseClass() {
    return ItemUpshelfListResponse.class;
  }
