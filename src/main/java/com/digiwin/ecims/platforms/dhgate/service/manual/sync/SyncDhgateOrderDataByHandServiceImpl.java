package com.digiwin.ecims.platforms.dhgate.service.manual.sync;
...
@Service("syncDhgateOrderDataByHandServiceImpl")
public class SyncDhgateOrderDataByHandServiceImpl implements SyncOrderDataByHandService {
