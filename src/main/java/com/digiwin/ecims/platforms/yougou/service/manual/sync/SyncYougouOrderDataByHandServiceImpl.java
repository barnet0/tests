package com.digiwin.ecims.platforms.yougou.service.manual.sync;
...
@Service("syncYougouOrderDataByHandServiceImpl")
public class SyncYougouOrderDataByHandServiceImpl implements SyncOrderDataByHandService {
