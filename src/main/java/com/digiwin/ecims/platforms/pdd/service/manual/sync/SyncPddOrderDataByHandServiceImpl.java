package com.digiwin.ecims.platforms.pdd.service.manual.sync;
...
@Service("syncPddOrderDataByHandServiceImpl")
public class SyncPddOrderDataByHandServiceImpl implements SyncOrderDataByHandService {

  private static final Logger logger =
      LoggerFactory.getLogger(SyncPddOrderDataByHandServiceImpl.class);
  
  private static final String CLASS_NAME = "SyncPddOrderDataByHandServiceImpl";
