...
@Service
public class KaolaApiSyncOrdersDeliveredServiceImpl implements KaolaApiSyncOrdersDeliveredService{
	  @Autowired
	  ...
	  public Boolean syncOrders(TaskScheduleConfig taskScheduleConfig, AomsshopT aomsshopT)
	      throws Exception {
	    return syncOrdersPaied(taskScheduleConfig, aomsshopT);
	  }

	  public Boolean syncOrdersPaied(TaskScheduleConfig taskScheduleConfig, AomsshopT aomsshopT)
	      throws Exception {
	    return kaolaApiSyncOrdersService.syncOrder(taskScheduleConfig, aomsshopT, OrderStatus.DELIVERED);
	  }
