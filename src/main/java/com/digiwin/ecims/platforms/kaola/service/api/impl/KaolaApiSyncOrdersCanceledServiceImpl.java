...
@Service
public class KaolaApiSyncOrdersCanceledServiceImpl implements KaolaApiSyncOrdersCanceledService {
	  @Autowired
	  ...
	  public Boolean syncOrders(TaskScheduleConfig taskScheduleConfig, AomsshopT aomsshopT)
	      throws Exception {
	    return syncOrdersCanceled(taskScheduleConfig, aomsshopT);
	  }

	  public Boolean syncOrdersCanceled(TaskScheduleConfig taskScheduleConfig, AomsshopT aomsshopT)
	      throws Exception {
	    return kaolaApiSyncOrdersService.syncOrder(taskScheduleConfig, aomsshopT, OrderStatus.CANCELED);
	  }
	@Override
