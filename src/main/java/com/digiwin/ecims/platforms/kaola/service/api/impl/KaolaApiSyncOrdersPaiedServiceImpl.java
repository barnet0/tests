...
@Service
public class KaolaApiSyncOrdersPaiedServiceImpl implements KaolaApiSyncOrdersPaiedService{
	  @Autowired
	  ...
	  public Boolean syncOrdersPaied(TaskScheduleConfig taskScheduleConfig, AomsshopT aomsshopT)
	      throws Exception {
	    return kaolaApiSyncOrdersService.syncOrder(taskScheduleConfig, aomsshopT, OrderStatus.PAIED);
	  }
