...
public class GetOrder {
	...
	private String order_business_remark;
	private List<GetOrderExpress> order_expresses;
	private String order_id;
	private String order_origin_price;
	private String order_real_price;

	private List<GetOrderSku>  order_skus;
	...
	public void setOrder_status_name(int order_status) {
	...
	public List<GetOrderSku> getOrder_skus() {
		return order_skus;
	}
	public void setOrder_skus(List<GetOrderSku> order_skus) {
	...
	public List<GetOrderExpress> getOrder_expresses() {
		return order_expresses;
	}
	public void setOrder_expresses(List<GetOrderExpress> order_expresses) {
