...
@Service("taobaoTbAomsrefundTPostServiceImpl")
public class TaobaoTbAomsrefundTPostServiceImpl implements OnTimeTaskBusiJob {
  ...
  public boolean timeOutExecute(String... args) throws Exception {
    ...
    basePostService.timeOutExecute(
        taskService.getTaskScheduleConfigInfo(
            TaobaoCommonTool.REF_POST_SCHEDULE_TYPE), AomsrefundT.class);
