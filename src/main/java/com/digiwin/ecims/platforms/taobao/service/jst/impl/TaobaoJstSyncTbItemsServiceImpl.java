...
@Service
public class TaobaoJstSyncTbItemsServiceImpl extends AbstractTaobaoJstSyncService implements TaobaoJstSyncTbItemsService {

  @Autowired
  private BaseDAO baseDAO;

  @Autowired
  private TaobaoJdpTbItemService tableJdpTbItem;
  ...
  protected void saveJstSourceToLog(PostBean jstPostData, String api, String result) {
    ...
    if (AbstractTaobaoTbItem.isApiInScope(api)) {
      loginfoOperateService.newTransaction4SaveSource(startTime, endTime,
          TaobaoCommonTool.STORE_TYPE, api, result, SourceLogBizTypeEnum.AOMSITEMT.getValueString(),
  ...
  protected List<? extends Object> parseTaobaojstRes(TaobaoRes taobaoRes, String storeId)
      throws ApiException, IOException {
    return tableJdpTbItem.parseTaobaoResToAomsitemT(taobaoRes, storeId);
  }
