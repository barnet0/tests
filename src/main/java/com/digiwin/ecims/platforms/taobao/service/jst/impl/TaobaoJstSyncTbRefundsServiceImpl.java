...
@Service
public class TaobaoJstSyncTbRefundsServiceImpl extends AbstractTaobaoJstSyncService implements TaobaoJstSyncTbRefundsService {

  @Autowired
  private BaseDAO baseDAO;

  @Autowired
  private TaobaoJdpTbRefundService tableJdpTbRefund;
  ...
  protected void saveJstSourceToLog(PostBean jstPostData, String api, String result) {
    ...
    if (AbstractTaobaoTbRefund.isApiInScope(api)) {
      loginfoOperateService.newTransaction4SaveSource(startTime, endTime,
          TaobaoCommonTool.STORE_TYPE, api, result, 
  ...
  protected List<? extends Object> parseTaobaojstRes(TaobaoRes taobaoRes, String storeId)
      throws ApiException, IOException {
    return tableJdpTbRefund.parseTaobaoResToAomsrefundT(taobaoRes, storeId);
  }
