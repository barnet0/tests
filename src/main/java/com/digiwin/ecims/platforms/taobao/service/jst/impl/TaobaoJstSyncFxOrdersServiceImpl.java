...
@Service
public class TaobaoJstSyncFxOrdersServiceImpl extends AbstractTaobaoJstSyncService implements TaobaoJstSyncFxOrdersService {

  @Autowired
  private BaseDAO baseDAO;

  @Autowired
  private TaobaoJdpFxTradeService tableJdpFxTrade;
  ...
  protected void saveJstSourceToLog(PostBean jstPostData, String api, String result) {
    ...
    if (AbstractTaobaoFxTrade.isApiInScope(api)) {
      loginfoOperateService.newTransaction4SaveSource(startTime, endTime,
          TaobaoCommonTool.STORE_TYPE_FX, api, result, SourceLogBizTypeEnum.AOMSORDT.getValueString(),
  ...
  protected List<? extends Object> parseTaobaojstRes(TaobaoRes taobaoRes, String storeId)
      throws ApiException, IOException {
    return tableJdpFxTrade.parseTaobaoResToAomsordT(taobaoRes, storeId);
  }
