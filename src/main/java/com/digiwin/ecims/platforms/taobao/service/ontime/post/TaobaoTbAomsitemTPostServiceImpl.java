...
@Service("taobaoTbAomsitemTPostServiceImpl")
public class TaobaoTbAomsitemTPostServiceImpl implements OnTimeTaskBusiJob {
  ...
  public boolean timeOutExecute(String... args) throws Exception {
    ...
    basePostService.timeOutExecute(
        taskService.getTaskScheduleConfigInfo(
            TaobaoCommonTool.ITE_POST_SCHEDULE_TYPE), AomsitemT.class);
