package com.digiwin.ecims.platforms.icbc.service.manual.sync;
 ...
 *
 */
@Service("syncICBCOrderDataByHandServiceImpl")
public class SyncICBCOrderDataByHandServiceImpl implements SyncOrderDataByHandService {
  
  private static final Logger logger =
      LoggerFactory.getLogger(SyncICBCOrderDataByHandServiceImpl.class);

  private static final String CLASS_NAME = "SyncICBCOrderDataByHandServiceImpl";
  ...
  public String syncOrderDataByCreateDate(String storeId, String startDate, String endDate) {
    ...
    long totalSize = 0l;
    try {
      totalSize = icbcApiSyncOrdersService.syncOrdersByCreated(startDate, endDate, storeId, null);
    } catch (IOException e) {
  ...
  public String syncOrderDataByModifyDate(String storeId, String startDate, String endDate) {
    ...
    long totalSize = 0l;
    try {
      totalSize = icbcApiSyncOrdersService.syncOrdersByIncremental(startDate, endDate, storeId, null);
    } catch (IOException e) {
      loginfoOperateService.newTransaction4SaveLog(InetAddressTool.getLocalIpv4(),
  ...
  public String syncOrderDataByOrderId(String storeId, String orderId) {
    SyncResOrderHandBean syncResOrderHandBean = null;
    try {
      icbcApiSyncOrdersService.syncOrderByOrderId(storeId, orderId);
    } catch (IOException e) {
      loginfoOperateService.newTransaction4SaveLog(InetAddressTool.getLocalIpv4(),
