...
@Service("vipItemUpdateServiceImpl")
public class VipItemUpdateServiceImpl extends UpdateTask implements OnTimeTaskBusiJob {

  private static final Logger logger = LoggerFactory.getLogger(VipItemUpdateServiceImpl.class);
  ...
  public boolean timeOutExecute(String... args) throws Exception {
    logger.info("定时任务开始--进入-VipItemUpdateServiceImpl--取得唯品会商品数据---方法");
    ...
    scheduleTypeBuffer.append(VipCommonTool.ITEM_UPDATE_SCHEDULE_NAME_PREFIX);
    int prefixLength = VipCommonTool.ITEM_UPDATE_SCHEDULE_NAME_PREFIX.length();
    ...
    try {
      ...
      loginfoOperateService.newTransaction4SaveLog(InetAddressTool.getLocalIpv4(),
          "VipItemUpdateServiceImpl", LogInfoBizTypeEnum.ECI_REQUEST.getValueString(),
    ...
    logger.info("定时任务结束-VipItemUpdateServiceImpl--取得唯品会商品数据---方法");
    return false;
  }
