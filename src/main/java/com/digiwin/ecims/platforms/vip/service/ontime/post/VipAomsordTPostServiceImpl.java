...
@Service("vipAomsordTPostServiceImpl")
public class VipAomsordTPostServiceImpl implements OnTimeTaskBusiJob {
  ...
  public boolean timeOutExecute(String... args) throws Exception {
    ...
    basePostService.timeOutExecute(
        taskService.getTaskScheduleConfigInfo(
            VipCommonTool.ORD_POST_SCHEDULE_TYPE), AomsordT.class);
