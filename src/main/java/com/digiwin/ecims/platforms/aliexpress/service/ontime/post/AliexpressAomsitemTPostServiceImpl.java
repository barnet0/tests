...
@Service("aliexpressAomsitemTPostServiceImpl")
public class AliexpressAomsitemTPostServiceImpl implements OnTimeTaskBusiJob {
  ...
  public boolean timeOutExecute(String... args) throws Exception {
    ...
    basePostService.timeOutExecute(
        taskService.getTaskScheduleConfigInfo(
            AliexpressCommonTool.ITE_POST_SCHEDULE_TYPE), AomsitemT.class);
