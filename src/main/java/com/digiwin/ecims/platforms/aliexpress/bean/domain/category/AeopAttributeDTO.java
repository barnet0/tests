...
public class AeopAttributeDTO implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -8434705468456871379L;
  ...
  // 否 发布属性值
  private List<AeAttrValueDTO> values;
  ...
  public List<AeAttrValueDTO> getValues() {
    return values;
  }

  public void setValues(List<AeAttrValueDTO> values) {
    this.values = values;
  }
