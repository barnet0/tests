...
public class AeopAttributeDTO2 implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -2601106508111634666L;
  ...
  // 否 发布属性值
  private List<AeAttrValueDTO2> values;
  ...
  public List<AeAttrValueDTO2> getValues() {
    return values;
  }

  public void setValues(List<AeAttrValueDTO2> values) {
    this.values = values;
  }
