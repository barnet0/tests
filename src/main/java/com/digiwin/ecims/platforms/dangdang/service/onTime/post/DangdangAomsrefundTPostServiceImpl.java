...
@Service("dangdangAomsrefundTPostServiceImpl")
public class DangdangAomsrefundTPostServiceImpl implements OnTimeTaskBusiJob {
  ...
  public boolean timeOutExecute(String... args) throws Exception {
    ...
    basePostService.timeOutExecute(
        taskService.getTaskScheduleConfigInfo(
            DangdangCommonTool.REF_POST_SCHEDULE_TYPE), AomsrefundT.class);
